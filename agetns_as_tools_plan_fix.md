...
1. **Display config restoration logic is incomplete**
...
2. **Instance naming races on shared child objects**
...
3. **Direct reliance on private internals of `RichProgressDisplay`**
...
4. **`MessageType` import is unused**
...
5. **Stats are per-agent only, not per-instance**
