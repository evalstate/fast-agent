...
def test_render_model_chip_escapes_prompt_toolkit_html_in_model_label() -> None:
    chip = render_model_chip(model_label="provider<model&1>")

    assert chip == f"<style bg='{MODEL_CHIP_COLOR}'>provider&lt;model&amp;1&gt;</style>"
