...
BUILTIN_MODEL_ALIASES: Final[dict[str, str]] = {
    ...
    "copilot.opus": "copilot.claude-opus-5.5",
    "copilot.opus55": "copilot.claude-opus-5.5",
    ...
    "gemini3.8flash": "gemini-3.8-flash",
    ...
    "grok46": "xai.grok-4.6",
    "grok47": "xai.grok-4.7",
    "grok47fast": "xai.grok-4.7-build-fast",
    "grokfast": "xai.grok-4.7-build-fast",
