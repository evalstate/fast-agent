...
def render_help_lines(*, show_webclear_help: bool) -> list[str]:
    lines = [
        ...
        "  /mcp session new [server] [--title <title>] - Create a new experimental session",
        "  /mcp session use <server> <session_id> - Set active cookie to an existing session",
        "  /mcp session clear [server|--all] - Clear one cookie or the full jar",
